...
const details = [
  { icon: '📧', label: 'Email', value: 'landvaluation.codehub@gmail.com' },
  { icon: '📞', label: 'Phone', value: '+94 11 234 5678' },
  { icon: '📍', label: 'Address', value: 'Moratuwa, Sri Lanka' },
]
    ...
    <div className="mt-10 grid gap-4 sm:grid-cols-3">
      {details.map((d) => (
        <Card key={d.label} className="p-6 text-center">
          <div className="mx-auto mb-2 text-2xl">{d.icon}</div>
          <p className="text-[11px] uppercase tracking-wide text-emerald-200/60">{d.label}</p>
