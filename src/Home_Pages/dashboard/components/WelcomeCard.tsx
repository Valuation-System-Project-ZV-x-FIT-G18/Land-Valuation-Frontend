    ...
    <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-emerald-200/80">{role}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 self-start rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs sm:self-auto">
        <span className="text-emerald-200/70">User ID</span>
        <span className="font-medium text-gold-300">{userId}</span>
      </div>
    </div>
  </Card>
)
