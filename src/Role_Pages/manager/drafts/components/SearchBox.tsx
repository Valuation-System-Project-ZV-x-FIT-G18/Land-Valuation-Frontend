...
const SearchBox = ({ value, onChange, placeholder = 'Search by Project ID, owner or location…' }: Props) => (
  <div className="relative mx-auto max-w-lg">
    ...
    <input
      ...
      className="w-full rounded-xl border border-white/15 bg-white/5 py-2.5 pl-10 pr-4 text-sm text-white placeholder-emerald-200/40 outline-none transition focus:border-gold-400/60 focus:ring-2 focus:ring-gold-400/30"
    />
  </div>
)
