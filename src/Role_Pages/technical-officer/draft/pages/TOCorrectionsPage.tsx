  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="text-center">
        ...
        <p className="mx-auto mt-2 max-w-xl text-emerald-100">Reports returned by Manager L3 appear here with the correction reason. Update and resubmit them for review.</p>
      </div>
