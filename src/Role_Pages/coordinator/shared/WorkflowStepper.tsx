...
type Step = { id: WorkflowStepId; label: string; short: string; to: string }

const STEPS: Step[] = [
  { id: 'register', label: 'Register Applicant', short: 'Register', to: '/coordinator/create-project' },
  { id: 'project', label: 'Create Project', short: 'Project', to: '/coordinator/new-project' },
  { id: 'valuation', label: 'New Valuation', short: 'Valuation', to: '/coordinator/new-valuation' },
  { id: 'assign', label: 'Assign Officer', short: 'Assign', to: '/coordinator/fleet-management/assign' },
]
...
const WorkflowStepper = ({ current }: { current: WorkflowStepId }) => {
  ...
  return (
    <nav
      ...
      className="mx-auto mb-8 w-full max-w-2xl animate-fade-in"
    >
