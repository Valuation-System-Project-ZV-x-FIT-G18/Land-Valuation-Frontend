    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {loading ? (
        ...
        <Card className="p-8 text-center">
          <p className="font-semibold text-gold-200">No reports yet</p>
          <p className="mt-1 text-sm text-emerald-100/70">Finalised reports for your projects will appear here.</p>
        </Card>
      ) : (
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                {r.paid ? (
                  <button
                    ...
                    className="rounded-lg border border-gold-400/40 bg-gold-400/10 px-4 py-2 text-sm font-medium text-gold-200 transition hover:bg-gold-400/20"
                  >
                    View report →
                  </button>
                ) : (
